...
def main(_):
    if FLAGS.binary_img:
        tfrecord_name = './data/GLDv2/gldv2_sample_1000.tfrecord'
    else:
        tfrecord_name = './data/GLDv2/gldv2.tfrecord'
    ...
    for idx, parsed_record in enumerate(train_dataset.take(num_samples)):
        ...
        if FLAGS.visualization:
            ...
            cv2.imwrite('./data/imgs/{}_img.jpg'.format(idx), cv2.cvtColor(recon_img, cv2.COLOR_RGB2BGR))
